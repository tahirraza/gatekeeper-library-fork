...
This repo contains common policies needed in [Pod Security Policy](https://kubernetes.io/docs/concepts/policy/pod-security-policy/) but implemented as Constraints and Constraint Templates with Gatekeeper.
